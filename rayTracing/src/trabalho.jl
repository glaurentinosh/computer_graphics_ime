...
persistentPath = string("imgs/out", "Ks", string(Ks), "n", string(n), "Kdr-Kdg-Kdb", string(Kdr),string(Kdg),string(Kdb), "lightPos", string(lightPos...), "I", string(I...), "Iamb", string(Iamb...) , ".png")
